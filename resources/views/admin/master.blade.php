  ...
  <body>
    ...
    <div class="br-sideleft overflow-y-auto">
      ...
      <div class="br-sideleft-menu">
        ...
        <!-- </a> -->
        <!-- br-menu-link -->
        <a href="{{route('banner_admin')}}" class="br-menu-link">
          <div class="br-menu-item">
            <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
            <span class="menu-item-label">Hình Ảnh </span>
          </div>
        </a>
        ...
        <ul class="br-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{route('user_admin')}}" class="nav-link">Danh Sách User</a></li>
          <!-- <li class="nav-item"><a href="table-datatable.html" class="nav-link">Data Table</a></li> -->
        </ul>

        <a href="{{route('list_contact')}}" class="br-menu-link active">
          <div class="br-menu-item">
